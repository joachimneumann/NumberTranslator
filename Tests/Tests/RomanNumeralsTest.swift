...
@Test func RomanNumerals() {
    ...
    #expect(translator.translate(5_000, to: .romanNumerals).x == "V OVERLINE")
    #expect(translator.translate(10_000, to: .romanNumerals).x == "X OVERLINE")
    #expect(translator.translate(19876, to: .romanNumerals).x == "XIX OVERLINE DCCCLXXVI")
    #expect(translator.translate(36_000, to: .romanNumerals).x == "XXXVI OVERLINE")
    #expect(translator.translate(50_000, to: .romanNumerals).x == "L OVERLINE")
    #expect(translator.translate(54321, to: .romanNumerals).x == "LIV OVERLINE CCCXXI")
    #expect(translator.translate(87654, to: .romanNumerals).x == "LXXXVII OVERLINE DCLIV")
    #expect(translator.translate(98765, to: .romanNumerals).x == "XCVIII OVERLINE DCCLXV")
    #expect(translator.translate(100_000, to: .romanNumerals).x == "C OVERLINE")
    #expect(translator.translate(123_456, to: .romanNumerals).x == "CXXIII OVERLINE CDLVI")
    #expect(translator.translate(300000, to: .romanNumerals).x == "CCC OVERLINE")
    #expect(translator.translate(500_000, to: .romanNumerals).x == "D OVERLINE")
    #expect(translator.translate(987_654, to: .romanNumerals).x == "CMLXXXVII OVERLINE DCLIV")
    #expect(translator.translate(1_000_000, to: .romanNumerals).x == "M OVERLINE")

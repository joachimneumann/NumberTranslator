...
for file in glob.glob("groundtruth/*.txt"):
    ...
    print(fileName)
    f = open(fileName, 'w')
    writeln("// Note: This file is automatically generated by the python script Tests/testsFromGroundtruth.py")
    writeln("//       Running this script will be overwrite any changes you make to this file")
    writeln("")
